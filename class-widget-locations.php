        ...
        public function list_locations( $settings ) {
            ...
            if( count( $terms ) > 0 ) {
                ...
                foreach( $terms as $term ) {
					...
					$get_location_term = get_term_meta( $term->term_id, 'image' );
					$get_location_image = wp_get_attachment_image_url($get_location_term[0]);
                    ...
                    $html .= '<li>';
					$html .= '<img src="' . esc_url( $get_location_image ) . '" />';
